            ...
            <div className="row">
               <div className="col-lg-6">
                  <div className="tg-header-top-info d-flex align-items-center">
                     ...
                     <Link href="mailto:info@Horizon Bound Travels.com"><i className="mr-5 fa-regular fa-envelope"></i> info@Horizon Bound Travels.com</Link>
                  </div>
               </div>
               <div className="col-lg-6">
                  <div className="tg-header-top-info d-flex align-items-center justify-content-end">
                     <Link href="tel:+8219098536"><i className="fa-sharp fa-regular fa-phone"></i> +91 82190-98536</Link>
                     <span className="tg-header-dvdr mr-10 ml-10"></span>
