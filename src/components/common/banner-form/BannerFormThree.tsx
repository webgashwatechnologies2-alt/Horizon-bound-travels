...
const BannerFormThree = () => {
   ...
   return (
      <div className="tg-booking-form-area tg-booking-form-space pb-0">
         <div className="container">
            <div className="row">
               <div className="col-lg-12">
                  <div className="tg-booking-form-wrap">
                     <div className="tg-booking-form-tabs">
                        <div className="nav nav-tab justify-content-start justify-content-lg-center" id="nav-tab" role="tablist">
