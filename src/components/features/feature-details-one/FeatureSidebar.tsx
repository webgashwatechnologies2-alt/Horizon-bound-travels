      ...
      <form onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="tg-tour-about-date p-relative">
               ...
               <span className="calender">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <path d="M11.1111 1V3.80003M4.88888 1V3.80003M1 6.59992H15M2.55556 2.39988H13.4444C14.3036 2.39988 15 3.02668 15 3.79989V13.6C15 14.3732 14.3036 15 13.4444 15H2.55556C1.69645 15 1 14.3732 1 13.6V3.79989C1 3.02668 1.69645 2.39988 2.55556 2.39988Z" stroke="#F46B08" strokeWidth="1.1" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
               </span>
         ...
         <div className="tg-tour-about-tickets-wrap mb-15">
            ...
            <div className="tg-tour-about-tickets mb-10">
               <div className="tg-tour-about-tickets-adult">
                  <span>Infant </span>
                  <p className="mb-0">(0-4 years) <span>Free</span></p>
               </div>
               <div className="tg-tour-about-tickets-quantity">
                  <NiceSelect
                     className="select  item-first"
         ...
         <div className="tg-tour-about-coast d-flex align-items-center flex-wrap justify-content-between mb-20">
            ...
            <h5 className="total-price" style={{ fontSize: "20px" }}>Price On Request</h5>
         </div>
