                  ...
                  <div className="tg-tour-about-wrap mr-55">
                     <div className="tg-tour-about-content">
                        ...
                        <div className="tg-tour-about-map mb-40">
                           ...
                           <p className="text-capitalize lh-28">Experience the majestic beauty of the Himalayas. Designed specifically for travelers who want to explore the snow-capped peaks and lush valleys of Himachal Pradesh.</p>
