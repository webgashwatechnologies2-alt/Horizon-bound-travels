...
import thumb_1 from "@/assets/img/listing/su/hm1.jpg"
import thumb_2 from "@/assets/img/listing/listing-3/bliskullu.jpg"
import thumb_3 from "@/assets/img/listing/listing-3/heavenhm.jpg"
import thumb_4 from "@/assets/img/listing/listing-3/adventure.jpg"
               ...
               <div className="row align-items-end mb-35">
                  <div className="col-xl-9 col-lg-8">
                     <div className="tg-tour-details-video-title-wrap">
                        <h2 className="tg-tour-details-video-title mb-15">Shimla Manali from Delhi Tour</h2>
                        <div className="tg-tour-details-video-location d-flex flex-wrap">
                           <span className="mr-25"><i className="fa-regular fa-location-dot"></i> Shimla & Manali, Himachal Pradesh</span>
               ...
               <div className="row gx-15 mb-25">
                  <div className="col-lg-7">
                     <div className="tg-tour-details-video-thumb mb-15">
                        <Image className="w-100" src={thumb_1} alt="Shimla Manali" style={{ height: "450px", objectFit: "cover", borderRadius: "10px" }} />
                     </div>
                  </div>
                     ...
                     <div className="row  gx-15">
                        <div className="col-12">
                           <div className="tg-tour-details-video-thumb p-relative mb-15">
                              <Image className="w-100" src={thumb_2} alt="Shimla Manali" style={{ height: "217px", objectFit: "cover", borderRadius: "10px" }} />
                        ...
                        <div className="col-lg-6 col-md-6">
                           <div className="tg-tour-details-video-thumb mb-15">
                              <Image className="w-100" src={thumb_3} alt="Shimla Manali" style={{ height: "217px", objectFit: "cover", borderRadius: "10px" }} />
                           </div>
                        </div>
                        <div className="col-lg-6 col-md-6">
                           <div className="tg-tour-details-video-thumb mb-15">
                              <Image className="w-100" src={thumb_4} alt="Shimla Manali" style={{ height: "217px", objectFit: "cover", borderRadius: "10px" }} />
                           </div>
                        </div>
                     </div>
                  </div>
