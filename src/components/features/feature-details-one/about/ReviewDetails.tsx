            ...
            <li>
               <div className="tg-tour-about-cus-review d-flex mb-40">
                  ...
                  <div>
                     ...
                     <p className="text-capitalize lh-28 mb-10">Amazing experience! The tour was very well organized. Shimla and Manali are breathtaking, and the guide made sure we didn&apos;t miss any important spots. Highly recommended for families.</p>
            ...
            <li>
               <div className="tg-tour-about-cus-review d-flex mb-40">
                  ...
                  <div>
                     ...
                     <p className="text-capitalize lh-28 mb-10">Loved the trip! The snowy mountains in Manali were incredible, and everything from hotels to transport was perfectly managed. The Kullu Valley stop was a nice bonus.</p>
                     <Link className="tg-tour-about-cus-reply" href="#">Reply</Link>
                  </div>
               </div>
            </li>
