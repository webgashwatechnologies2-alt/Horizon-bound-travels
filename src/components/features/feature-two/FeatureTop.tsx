   ...
   const niceSelectHandler = (item: Option) => {
      ...
      switch (item.value) {
         case 'popular':
            ...
            break;
         case 'price':
            // Price is a string like 'Price On Request', so sorting by price doesn't apply well, 
            // but we can leave it as is or parse if needed. For now, no sorting by price.
            break;
         case 'rating':
