...
import thumb_2 from "@/assets/img/tour-details/details-2/slider-big-6.jpg"
import thumb_3 from "@/assets/img/tour-details/details-2/slider-big-1.jpg"
import thumb_4 from "@/assets/img/tour-details/details-2/slider-big-6.jpg"
import thumb_5 from "@/assets/img/tour-details/details-2/slider-big-1.jpg"
            ...
            {slider_b.map((item, i) => (
               <SwiperSlide key={i} className="swiper-slide">
                  <div className="tg-tour-details-gallery-thumb">
                     <Image className="w-100" src={item} alt="" style={{ height: '450px', objectFit: 'cover' }} />
                  </div>
               </SwiperSlide>
            ))}
