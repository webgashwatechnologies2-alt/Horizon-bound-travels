...
const CtaTwo = () => {
   return (
      <div className="tg-banner-area include-bg" style={{ backgroundImage: `url(/assets/img/banner/Frameneww.jpg)` }}>
         <div className="container">
            <div className="col-lg-12">
               <div className="tg-banner-2-content text-center">
                  <div className="tg-about-section-title mb-25">
                     <h5 style={{color : "#F46B08"}} className="tg-section-subtitle mb-10 wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">Next Adventure Destination</h5>
