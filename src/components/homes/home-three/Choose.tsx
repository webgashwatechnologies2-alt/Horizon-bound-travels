...
import choose_thumb from "@/assets/img/chose/chooseneww.jpg"
import choose_thumb2 from "@/assets/img/chose/rjnew.jpg"
                     ...
                     <div className="row">
                        <div className="col-lg-3 col-md-6">
                           <div className="tg-chose-thumb">
                              ...
                              <Image className="w-100 h-100 wow fadeInRight" data-wow-delay=".4s" data-wow-duration=".9s" src={choose_thumb} alt="chose" />
                           </div>
                        </div>
                        <div className="col-lg-9 col-md-6">
                           <div className="tg-chose-thumb-inner p-relative">
                              <div className="tg-chose-thumb-2 wow fadeInRight" data-wow-delay=".5s" data-wow-duration=".9s">
                                 <Image className="w-100 h-100 tg-round-15" src={choose_thumb2} alt="chose" />
                              </div>
